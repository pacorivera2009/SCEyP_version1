        ...
        private void Export(LocalReport report)
        {
            string deviceInfo =
              @"<DeviceInfo>
                ...
                <PageWidth>0.0000000000000000000000001in</PageWidth>
                <PageHeight>0.0in</PageHeight>
                <MarginTop>0.0000000000000000000000001in</MarginTop>
                <MarginLeft>0.000000000000000000000001in</MarginLeft>
                <MarginRight>0.0in</MarginRight>
                <MarginBottom>0.0000000000000000000001in</MarginBottom>
            </DeviceInfo>";
            Warning[] warnings;
